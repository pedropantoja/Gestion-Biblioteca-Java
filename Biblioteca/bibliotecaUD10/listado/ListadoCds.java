...
public class ListadoCds {

	private Connection conn;
	
	public ListadoCds(Connection conn) {
		this.conn=conn;
		...
		try {
			...
			Paragraph cabecera=new Paragraph("Listado de CDs",
			...
			while(rset.next()){
				tabla.addCell(""+rset.getString("codcdrom"));
